...
public func timetablePermanentRequest(accessToken: String, completion: @escaping (Bool) -> Void) {
    let headers = [
    ...
    print("Timetable Permanent API called")
    
    let request = NSMutableURLRequest(url: NSURL(string: "https://bakalari.uzlabina.cz/api/3/timetable/permanent")! as URL,
